...
export default function DiscoverPage() {
  ...
  return (
    <main className="discover-page section-pad">
      <div className="section-inner">
        ...
        <header className="discover-page__head">
          <div>
            <p className="meta">Discover</p>
            <span className="hairline" aria-hidden="true" />
            <h1 className="display discover-page__title">The mixed archive feed</h1>
            <p className="discover-page__lede">
              Cars and motorcycles lead the chamber. Watches follow as a secondary collecting domain.
            </p>
          </div>
          <button
            type="button"
